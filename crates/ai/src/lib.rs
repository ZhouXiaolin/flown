...
pub use images_api_registry::{
    ...
    get_images_api_providers, register_built_in_images_api_providers,
    register_images_api_provider, reset_images_api_providers, unregister_images_api_providers,
};
...
pub use providers::{
    ...
    AzureOpenAIResponsesOptions, BedrockOptions, BedrockThinkingDisplay,
    FauxAssistantMessageContent, FauxAssistantMessageOptions, FauxContentBlock, FauxModelDefinition,
    FauxProviderRegistration, FauxResponseStep, FauxTokenSize, GoogleOptions,
    ...
    register_faux_provider, stream_anthropic_public, stream_openai_completions_public,
    stream_openai_responses_public, stream_simple_anthropic,
