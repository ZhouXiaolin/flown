    ...
    For::new(ForProps {
        ...
        render: {
            ...
            move |_idx: Signal<usize>, _i: usize| {
                ...
                let popup_items = Signal::derive(move || {
                    slash_popup.with(|popup| editor::completion_items(popup.as_ref()))
                });
                ...
                create_effect(move || {
                    if slash_popup.with(|popup| popup.is_some()) {
                        root_for_effect.set_children(vec![
                            popup_for_effect.clone(),
                            editor_for_effect.clone(),
                        ]);
                    } else {
